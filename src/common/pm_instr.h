...
#define PM_TX_RESTART                   "PM_XR"
#define PM_FENCE_MARKER                 "PM_N"
#define PM_COMMIT_MARKER                "PM_C"
#define PM_BARRIER_MARKER               "PM_B"
#define PM_TX_ABORT                     "PM_XA"
#define PM_TX_TRYCOMMIT                 "PM_XY"
#define PM_TX_ROLLBACK                  "PM_XL"
...
#define PM_TRYCOMMIT_TXN(s)                             \
    ({                                              	\
        PM_TRACE("%d:%llu:%s:%s:%d:%s\n",              	\
			TENTRY_ID,		    	\
                PM_TX_TRYCOMMIT,                       	\
                LOC1,                           	\
                LOC2,s);                          	\
